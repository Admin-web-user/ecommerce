<template>
  <div class="glass-morph pa-2" style="z-index: 100;">
    <h1 style="margin-top: 10px;">
      Terms &amp; Conditions
    </h1>
    <p>Updated at {{ PolicyDate }}</p>
    <br>
    <h1>General Terms</h1>
    <p class="pa-3">
      <span
      ...
      >By accessing and placing an order with <a />, you confirm that you
        ...
        inability to use, the materials on this site, even if <a /> team or an
        ...
        costs thereof. <br><br>
        <a /> will not be responsible for any outcome that may occur during
    ...
    <p class="pa-10">
      <span
        class="s1"
      ><a>{{ Sitename }}</a> grants you a revocable, non-exclusive, non- transferable,
        ...
        <a>{{ Sitename }}</a> (referred to in these Terms &amp; Conditions as
        "<a>{{ Sitename }}</a>", "us", "we" or "our"), the provider of the
        <a>{{ Sitename }}</a> website and the services accessible from the
        <a>{{ Sitename }}</a> website (which are collectively referred to in these Terms
        &amp; Conditions as the "<a>{{ Sitename }}</a> Service"). <br><br>
    ...
    <ul class="ul1">
      <li class="li8">
        ...
        ><strong>Cookie:</strong> small amount of data generated by a website
          ...
          language preference or login information.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Company:</strong> when this policy mentions “Company,” “we,”
          “us,” or “our,” it refers to <a>{{ Sitename }}</a>,
          <a>{{ Location }}</a> that is responsible for your information
          under this Privacy Policy.<br></span>
      </li>
      <!---->
      <li class="li8">
        <span
          class="s1"
        ><strong>Country:</strong> where <a>{{ Sitename }}</a> or the owners/founders of
          <a>{{ Sitename }}</a> are based, in this case is <a>{{ Country }}</a>.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Customer:</strong> refers to the company, organization or
          person that signs up to use the <a>{{ Sitename }}</a> Service to manage the
          relationships with your consumers or service users.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Device:</strong> any internet connected device such as a
          ...
          <a>{{ Sitename }}</a> and use the services.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>IP address:</strong> Every device connected to the Internet
          is assigned a number known as an Internet protocol (IP) address. These
          ...
          connecting to the Internet.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Personnel:</strong> refers to those individuals who are
          employed by <a>{{ Sitename }}</a> or are under contract to perform a service on
          behalf of one of the parties.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Personal Data:</strong> any information that directly,
          ...
          identifiability of a natural person.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>Service:</strong> refers to the service provided by
          <a>{{ Sitename }}</a> as described in the relative terms (if available) and on
          this platform.<br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
      ...
      <li class="li8">
        <span
          class="s1"
        ><strong>Website:</strong> <a>{{ Sitename }}</a>’s site, which can be accessed
          via this URL: <a>www.{{ Sitename.toLowerCase() }}.com.</a><br></span>
      </li>
      <li class="li8">
        <span
          class="s1"
        ><strong>You:</strong> a person or entity that is registered with
          <a>{{ Sitename }}</a> to use the Services.<br></span>
      </li>
    </ul>
    <p class="p9">
      <br>
    ...
    <p class="pa-10">
      ...
      >The service is provided to you "AS IS" and "AS AVAILABLE" and with all
        ...
        free or that any errors or defects can or will be corrected.<br><br>
    ...
    <p class="pa-10">
      ...
      >This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE
        ...
        meaning allowable under law.</span>
    </p>
    <p class="pa-3">
      <br>
    </p>
    ...
    <p class="pa-10">
      ...
      >We are not responsible for any content, code or any other imprecision.
        ...
        Service at any time without prior notice.<br><br>
    ...
    <ul class="ul1">
      ...
      <!---->
      <li class="li16">
        <span class="s3">Via this Link: <a>https://{{ Sitename.toLowerCase() }}.com</a></span>
      </li>
      <!---->
    </ul>
  </div>
